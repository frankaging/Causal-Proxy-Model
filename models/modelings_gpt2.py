...
class IITGPT2ForSequenceClassification(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        if cls_hidden_reprs is not None:
            ...
            before_pooled_output = pooled_hidden_states
        else:
            ...
            pooled_hidden_states = transformer_outputs.hidden_states[-1][torch.arange(batch_size, device=self.device), sequence_lengths]
            before_pooled_output = transformer_outputs.hidden_states[self.interchange_hidden_layer][torch.arange(batch_size, device=self.device), sequence_lengths]
        #####
        ...
        return SequenceClassifierOutputWithPast(
            ...
            hidden_states=None if cls_hidden_reprs is not None else transformer_outputs.hidden_states,
